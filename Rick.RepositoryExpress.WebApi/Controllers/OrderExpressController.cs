...
namespace Rick.RepositoryExpress.WebApi.Controllers
{
    ...
    public class OrderExpressController : RickControllerBase
    {
        ...
        {
            var query = from packageorderapply in _packageorderapplyexpressService.Query<Packageorderapply>(t => t.Status == 1 && t.Orderstatus >= (int)OrderApplyStatus.申请打包 && t.Appuser == UserInfo.Id)
