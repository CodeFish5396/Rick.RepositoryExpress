...
namespace Rick.RepositoryExpress.WebApi.Controllers
{
    ...
    public class PackagecheckController : RickControllerBase
    {
        ...
        public PackagecheckController(ILogger<PackagecheckController> logger, IExpressclaimService expressclaimService, IIdGeneratorService idGenerator, RedisClientService redisClientService)
        {
            _logger = logger;
        ...
        /// <returns></returns>
        [HttpPut]
        public async Task<RickWebResult<object>> Put([FromQuery] long id, [FromQuery] string remark)
        {
            ...
            expressclaim.Status = (int)ExpressClaimStatus.待验货;
            await _expressclaimService.UpdateAsync(expressclaim);
            package.Status = (int)PackageStatus.待验货;
            package.Checkremark = remark;
            ...
            packagenote.Operator = (int)PackageNoteStatus.待验货;
