...
namespace Rick.RepositoryExpress.WebApi.Controllers
{
    ...
    public class UserAddressController : RickControllerBase
    {
        ...
        public UserAddressController(ILogger<UserAddressController> logger, ISysuserService sysuserService, IIdGeneratorService idGenerator, RedisClientService redisClientService)
        {
            _logger = logger;
